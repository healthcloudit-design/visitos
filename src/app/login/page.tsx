      ...
      <div className="w-full max-w-sm">
        <div className="rounded-2xl border border-white/10 bg-white p-7 shadow-xl">
          <div className="mb-5 flex justify-center">
            ...
            <img src="/logo.png" alt="Praxis Operativa" className="h-14 w-auto" />
          </div>

          <div className="mb-6 border-t border-gray-100 pt-4 text-center">
            <h1 className="text-xl font-bold tracking-tight text-brand-700">
              Visit<span className="text-gold-500">OS</span>
            </h1>
            <p className="mt-0.5 text-xs text-gray-500">CRM territorial para visitadores médicos</p>
          </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-[11px] text-white/50">© {new Date().getFullYear()} Praxis Operativa · VisitOS</p>
        </div>
      </div>
    </main>
  );
